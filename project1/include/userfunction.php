<?php
    ...
    function addcart(){
        ...
        if(isset($_POST['cart_btn'])){
            ...
            if($row_check==1){
                ...
                $add_cart=$con->prepare("INSERT INTO cart(pro_id, qnty, userid) VALUES('$pro_id', '1', '$id')");
    ...
    function cart_dis(){
        ...
        if($cart_empty==0){
            echo "<center><h2>No Item To Display In Your Cart.</h2></center>";
            echo "<center><h3>Continue Shopping And Add Foods To Your Cart.</h3></center>";
            echo "<center><h4><a href='indexuser.php'>Continue Shopping</a></h4></center>";
        }
        else{
    ...
    function vegetables(){
        ...
        $fetch_cat=$con->prepare("SELECT * FROM main_category WHERE cat_id='14'");
    ...
    function meat(){
        ...
        $fetch_cat=$con->prepare("SELECT * FROM main_category WHERE cat_id='15'");
        $fetch_cat->setFetchMode(PDO:: FETCH_ASSOC);
        $fetch_cat->execute();
    ...
    function fish(){
        ...
        $fetch_cat=$con->prepare("SELECT * FROM main_category WHERE cat_id='22'");
        $fetch_cat->setFetchMode(PDO:: FETCH_ASSOC);
        $fetch_cat->execute();
    ...
    function rice(){
        ...
        $fetch_cat=$con->prepare("SELECT * FROM main_category WHERE cat_id='20'");
        $fetch_cat->setFetchMode(PDO:: FETCH_ASSOC);
        $fetch_cat->execute();
    ...
    function gas(){
        ...
        $fetch_cat=$con->prepare("SELECT * FROM main_category WHERE cat_id='21'");
        $fetch_cat->setFetchMode(PDO:: FETCH_ASSOC);
        $fetch_cat->execute();
            ...
            echo "<div id='pro_img'>
                ...
                <div id='pro_features'>
                    ...
                    <ul>
                        ...
                        <li>Added date of the piece : ".$row_pro['pro_added_date']."</li>
                    </ul><br clear='all' />
                    <center>
                ...
                <div id='similar'>
                    ...
                    <ul>";
                        ...
                        $sim_pro=$con->prepare("SELECT * FROM products WHERE cat_id='$cat_id' LIMIT 0, 6");
